...
ACCResult = csv2rec('MRMR9ACCResult.csv')
#print MRMR18
...
plt.yticks(range(40, 80, 5), fontsize=14)
...
majors = ['MRMRNBACCFCD', 'MRMRNBACCFCQ', 'MRMRLRACCFCD', 'MRMRLRACCFCQ', 'MRMRRFACCFCD', 'MRMRRFACCFCQ', 'RFNBACC', 'RFNBACC', 'RFRFACC']
