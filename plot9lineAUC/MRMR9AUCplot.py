...
ACCResult = csv2rec('MRMR9AUCResult.csv')
#print MRMR18
...
majors = ['MRMRNBAUCFCD', 'MRMRNBAUCFCQ', 'MRMRLRAUCFCD', 'MRMRLRAUCFCQ', 'MRMRRFAUCFCD', 'MRMRRFAUCFCQ', 'RFNBAUC', 'RFNBAUC', 'RFRFAUC']
