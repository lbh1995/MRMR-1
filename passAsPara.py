...
#		outputTestResultPred.write("times = %d, selectMethod = %d, y_Pred = %s\n"%(i, selectMethod, y_Pred))
...
def getMRvalue(f, featureTrainNum, X_train, posIdx, negIdx):
	return f(featureTrainNum, X_train, posIdx, negIdx)
...
#print PCCij
outputTest = open("outputTestMR.txt", "w")
#outputTestResult = open("outputTestResultpred.txt", "w")
#outputTestResultFeature = open("outputTestResultFeaturepred.txt", "w")
#outputTestResultPred = open("outputTestResultPred.txt", "w")
...
#use T-Statis as metric 
trainFStatis = getMRvalue(getTrainFStatis, featureTrainNum, X_train, posIdx, negIdx)
